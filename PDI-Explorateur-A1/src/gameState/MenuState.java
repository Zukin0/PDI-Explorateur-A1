...
/**
 * @brief This class defines the menu state
...
public class MenuState extends GameState implements ImageObserver {
	...
	/**Initialization of necessary colors, images and fonts*/
	...
	/**
	 * @brief Method that detects the keyboard's clicks to interact with the user and go from one state to another
	 */
